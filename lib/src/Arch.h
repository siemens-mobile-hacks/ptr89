...
class Arch {
	public:
		...
		virtual std::pair<bool, uint32_t> decodeReference(uint32_t offset, const Pattern::Memory &memory) const = 0;
		virtual std::pair<bool, uint32_t> decodeBranchReference(uint32_t offset, const Pattern::Memory &memory) const = 0;
